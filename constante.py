...
TAILLE_MEMOIRE = 10
INCERTITUDE = 10.0 #Incertitude initale du système
Q = 2.0 #Confiance au processus
R = 5.0 #Confiance aux mesures
...
RAYON_POINT = 1*COEFF_AGRANDISSEMENT #En pixels, le rayon du point représentant les coordonnées filtrées
